...
def view(finding_name: str, finding_amount_of_unit_of_measure: float, finding_quantity: int):
    if isinstance(getstandardweight.get_standard_weight(finding_name), float) \
        ...
        total_stone_cost = single_component_cost * finding_quantity
        # Finding Labor Cost
        ...
        return {
            "final_finding_cost": final_stone_cost,
            "total_finding_cost": total_stone_cost,
            "total_finding_labor_cost": total_stone_labor_cost
        }
